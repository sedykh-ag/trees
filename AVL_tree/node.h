...
struct node {	// структура для представления узла дерева
	...
	node(const KeyType& input_key, const ValueType& input_value) : // конструктор узла с ключом и значением
	...
	node(const KeyType& input_key) : // конструктор узла с ключом без значения
